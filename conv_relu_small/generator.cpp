...
int main(int argc, char **argv)
{
    ...
    buffer buf05("buf05", {8, 2, 1024, 1024}, p_int32, a_output);
    ...
    std::vector<tiramisu::buffer*> buffs_list = {&buf01, &buf05, &buf00, &buf02, &buf03};
    ...
    {   
        ...
        comp05.interchange(i00, i02);
        
        comp04.vectorize(i03, 4);
        comp01.vectorize(i03, 4);
        comp05.vectorize(i03, 4);

...
int main(int argc, char **argv)
{
    ...
    // iterators
    int c00(3), c01(1026), c02(1026);
    var i00("i00", 0, c00) , i01("i01", 0, c01 - 2) , i02("i02", 0, c02 - 2) ;
    ...
    // buffers
    buffer buf01("buf01", {3, 1024, 1024}, p_int32, a_output);
    buffer buf00("buf00", {3, 1026, 1026}, p_int32, a_input);

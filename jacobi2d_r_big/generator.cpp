...
int main(int argc, char **argv)
{
    ...
    // iterators
    int c00(130), c01(1026);
    var i00("i00", 0, c00 - 2) , i01("i01", 0, c01 - 2) ;
    
    // computations
    input input00("input00", {i00, i01}, p_int32);

    computation comp01("comp01", {i00, i01}, 3 * (input00(i00 + 1, i01 + 1) + input00(i00 + 1,i01) + input00(i00 + 1, i01 + 2) + input00(i00 + 2, i01 + 1) + input00(i00, i01 + 1)));
    
    // buffers
    buffer buf01("buf01", {128, 1024}, p_int32, a_output);
    buffer buf00("buf00", {130, 1026}, p_int32, a_input);

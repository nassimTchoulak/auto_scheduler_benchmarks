...
int bench_function(struct halide_buffer_t *_buf03_buffer, struct halide_buffer_t *_buf04_buffer, struct halide_buffer_t *_buf00_buffer, struct halide_buffer_t *_buf01_buffer, struct halide_buffer_t *_buf02_buffer) HALIDE_FUNCTION_ATTRS;
int bench_function_old_buffer_t(struct buffer_t *_buf03, struct buffer_t *_buf04, struct buffer_t *_buf00, struct buffer_t *_buf01, struct buffer_t *_buf02) HALIDE_FUNCTION_ATTRS;
